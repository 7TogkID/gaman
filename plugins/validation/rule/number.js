...
export class RuleNumber extends BaseRuleBuilder {
     ...
     */
    number() {
        this.rules.push((key, val) => typeof val === 'number' ? true : `${key} must be a number`);
        return this;
    }
    /**
     ...
     */
    min(minValue) {
        this.rules.push((key, val) => typeof val === 'number' && val >= minValue
            ? true
     ...
     */
    max(maxValue) {
        this.rules.push((key, val) => typeof val === 'number' && val <= maxValue
            ? true
     ...
     */
    greaterThan(value) {
        this.rules.push((key, val) => typeof val === 'number' && val > value
            ? true
     ...
     */
    integer() {
        this.rules.push((key, val) => Number.isInteger(val) ? true : `${key} must be an integer`);
        return this;
    }
    /**
     ...
     */
    positive() {
        this.rules.push((key, val) => typeof val === 'number' && val > 0
            ? true
     ...
     */
    divisibleBy(divisor) {
        this.rules.push((key, val) => typeof val === 'number' && val % divisor === 0
            ? true
     ...
     */
    between(min, max) {
        this.rules.push((key, val) => typeof val === 'number' && val >= min && val <= max
            ? true
