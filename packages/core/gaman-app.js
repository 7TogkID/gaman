...
export class GamanApp {
    ...
    constructor(mainBlock) {
         ...
         */
        if (__classPrivateFieldGet(this, _GamanApp_blocks, "f").some((b) => b.path === mainBlock?.path)) {
    ...
    registerBlock(block) {
        ...
        block.path = formatPath(block.path || "/", __classPrivateFieldGet(this, _GamanApp_strict, "f"));
        __classPrivateFieldGet(this, _GamanApp_blocks, "f").push(block);
    }
    async requestHandle(req, res) {
        ...
        try {
            const blocksAndIntegrations = sortArrayByPriority([...__classPrivateFieldGet(this, _GamanApp_blocks, "f"), ...__classPrivateFieldGet(this, _GamanApp_integrations, "f")], "priority", "asc" //  1, 2, 3, 4, 5 // kalau desc: 5, 4, 3, 2, 1
            );
