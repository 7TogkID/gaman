...
exports.GAMAN_MIME = exports.detectExtension = exports.detectMime = void 0;
/**
 * Reference:
 * Inspired by Hono's internal mime utility.
 * https://github.com/honojs/hono/blob/main/src/utils/mime.ts
 */
const detectMime = (fileName, types = {}) => {
...
const detectExtension = (mimeType, types = {}) => {
    types = { ...GAMAN_MIME, ...types };
