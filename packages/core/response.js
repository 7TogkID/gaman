...
exports.Response = exports.RenderResponse = void 0;
...
class RenderResponse {
    constructor(viewName, viewData = {}, init = { status: 200 }) {
        ...
        tslib_1.__classPrivateFieldSet(this, _RenderResponse_viewName, viewName, "f");
        tslib_1.__classPrivateFieldSet(this, _RenderResponse_viewData, viewData, "f");
        tslib_1.__classPrivateFieldSet(this, _RenderResponse_init, init, "f");
    }
    getName() {
        return tslib_1.__classPrivateFieldGet(this, _RenderResponse_viewName, "f");
    }
    getData() {
        return tslib_1.__classPrivateFieldGet(this, _RenderResponse_viewData, "f");
    }
    getOptions() {
        return tslib_1.__classPrivateFieldGet(this, _RenderResponse_init, "f");
    }
}
...
class Response {
    constructor(body, options = {}) {
        ...
        this.body = body;
        this.headers = new headers_1.GamanHeaders(options.headers || {});
