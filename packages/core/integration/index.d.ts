...
export type IntegrationFactory<A extends AppConfig = AppConfig> = (app: GamanApp<A>) => {
    /**
...
export declare function defineIntegration<A extends AppConfig>(integration: IntegrationFactory<A>): IntegrationFactory<A>;
