...
export type RoutesFactory<TDeps extends object = object, A extends AppConfig = AppConfig> = (deps: TDeps) => RoutesDefinition<A>;
/**
 ...
 */
export declare function defineRoutes<TDeps extends object, A extends AppConfig>(factory: RoutesFactory<TDeps, A>): RoutesFactory<TDeps, A>;
