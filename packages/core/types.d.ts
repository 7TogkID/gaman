...
export type WebSocketServerHandler = (ctx: WebSocketContext) => Promise<WebSocketHandler> | WebSocketHandler;
...
export type NextResponse = Promise<Response | undefined> | Response | object | Array<any> | string | undefined;
